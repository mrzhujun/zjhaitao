define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'active/zhuanchang/index',
                    add_url: 'active/zhuanchang/add',
                    edit_url: 'active/zhuanchang/edit',
                    del_url: 'active/zhuanchang/del',
                    multi_url: 'active/zhuanchang/multi',
                    table: 'mall_active',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'active_title', title: __('Active_title')},
